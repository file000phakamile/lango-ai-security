...
// (lib/lango/mock-data.ts riskBand / components/lango/decision-badge.ts):
// gold #8A6323 for redacted, red #A83A3A for blocked, green #2F7A53 for
// cleared. Loaded first in manifest.json so later content scripts (any site
// adapter) can call showBanner() directly — MV3 content scripts listed
// together in one content_scripts entry share the same isolated-world
// global scope, in file-list order.
